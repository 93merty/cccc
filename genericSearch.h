 ...
 * Author: kadayif
 *
 * Created on 28 Kasım 2022 Pazartesi, 14:46
 */
 ...
 * Author: kadayif
 *
 * Created on 28 Kasım 2022 Pazartesi, 14:39
 */
...
/* printing the path in the search tree starting from root to the corresponding vertex */
void printPathForward(struct searchInfo *results,int v);

/* printing the path in the search tree starting from the vertex to the root vertex */
